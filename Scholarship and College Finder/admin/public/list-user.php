        ...
        <div class="main-content">
            ...
            <div class="card mt-1 shadow">
                <div class="card-header d-flex align-items-center mx-3 mt-2">
                    <h3 class="card-title mb-0 me-3" style="white-space: nowrap;">Users List</h3>
                ...
                <div class="card-body px-4 py-3">
                    <div class="table-responsive">
                        ...
                        <tbody>
                            ...
                            <td>
                                <a href="manage-user?update=<?php echo $row['user_id']; ?>"><button type="submit" class="btn btn-primary" name="add">Update</button></a>
                                <a href="../private/manage-user?delete=<?php echo $row['user_id']; ?>"><button type="submit" class="btn btn-danger" name="add">Delete</button></a>
                            </td>
                            </tr>
                            <?php 
