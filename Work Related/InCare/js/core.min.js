...
function(l, i, s, r) {
    ...
    h.Workers = [{
        ...
        run: function() {
            for (var t, e, i = this.settings.rtl ? 1 : -1, s = 2 * this.settings.stagePadding, o = this.coordinates(this.current()) + s, n = o + this.width() * i, a = [], r = 0, l = this._coordinates.length; r < l; r++)
                t = this._coordinates[r - 1] || 0,
                e = Math.abs(this._coordinates[r]) + s * i,
                (this.op(t, "<=", o) && this.op(t, ">", n) || this.op(e, "<", o) && this.op(e, ">", n)) && a.push(r);
    ...
    h.prototype.closest = function(i, s) {
        ...
        return this.settings.freeDrag || l.each(a, l.proxy(function(t, e) {
            return "left" === s && e - 30 < i && i < e + 30 ? o = t : "right" === s && e - n - 30 < i && i < e - n + 30 ? o = t + 1 : this.op(i, "<", e) && this.op(i, ">", a[t + 1] !== r ? a[t + 1] : e - n) && (o = "left" === s ? t + 1 : t),
            -1 === o
        }, this)),
    ...
    h.prototype.to = function(t, e) {
        var i, s = this.current(), o = t - this.relative(s), n = (0 < o) - (o < 0), a = this._items.length, r = this.minimum(), l = this.maximum();
        this.settings.loop ? (!this.settings.rewind && Math.abs(o) > a / 2 && (o += -1 * n * a),
        (i = (((t = s + o) - r) % a + a) % a + r) !== t && i - o <= l && 0 < i - o && (s = i - o,
        t = i,
        this.reset(s))) : t = this.settings.rewind ? (t % (l += 1) + l) % l : Math.max(r, Math.min(l, t)),
            ...
            "initialized.owl.carousel change.owl.carousel resized.owl.carousel": r.proxy(function(t) {
                if (t.namespace && this._core.settings && this._core.settings.lazyLoad && (t.property && "position" == t.property.name || "initialized" == t.type)) {
                    ...
                    i++)); s++ < i; )
                        ...
                        n && r.each(this._core.clones(this._core.relative(o)), a),
                        o++
                }
            }, this)
        },
...
function(c, e) {
    ...
    i.prototype.fetch = function(t, e) {
        ...
        if (-1 < (s = a.match(/(http:|https:|)\/\/(player.|www.|app.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com|be\-nocookie\.com)|vzaar\.com)\/(video\/|videos\/|embed\/|channels\/.+\/|groups\/.+\/|watch\?v=|v\/)?([A-Za-z0-9._%-]*)(\&\S+)?/))[3].indexOf("youtu"))
            i = "youtube";
    ...
    i.prototype.thumbnail = function(e, t) {
        ...
        var s, o, n = t.width && t.height ? "width:" + t.width + "px;height:" + t.height + "px;" : "", a = e.find("img"), r = "src", l = "", h = this._core.settings;
        if (e.wrap(c("<div/>", {
...
function(a) {
    ...
    e.prototype.swap = function() {
        ...
        o && s.one(a.support.animation.end, e).addClass("animated owl-animated-in").addClass(o)))
    }
    ,
...
function(o) {
    ...
    e.prototype.update = function() {
        var t, e, i = this._core.clones().length / 2, s = i + this._core.items().length, o = this._core.maximum(!0), n = this._core.settings, a = n.center || n.autoWidth || n.dotsData ? 1 : n.dotsEach || n.items;
...
function(s) {
    ...
    var e = function(t) {
        ...
        this._handlers = {
            "prepared.owl.carousel": s.proxy(function(t) {
                var e;
                !t.namespace || !this.owl.options.thumbs || this.owl.options.thumbImage || this.owl.options.thumbsPrerendered || this.owl.options.thumbImage ? t.namespace && this.owl.options.thumbs && this.owl.options.thumbImage && (e = s(t.content).find("img"),
                this._thumbcontent.push(e)) : void 0 !== s(t.content).find("[data-thumb]").attr("data-thumb") && this._thumbcontent.push(s(t.content).find("[data-thumb]").attr("data-thumb"))
            }, this),
            "initialized.owl.carousel": s.proxy(function(t) {
    ...
    e.prototype.listen = function() {
        ...
        i.thumbsPrerendered && (this._thumbcontent._thumbcontainer = s("." + i.thumbContainerClass)),
        s(this._thumbcontent._thumbcontainer).on("click", this._thumbcontent._thumbcontainer.children(), s.proxy(function(t) {
            ...
            i.thumbsPrerendered ? s("[data-slider-id=" + this._identifier + "]").trigger("to.owl.carousel", [e, i.dotsSpeed, !0]) : this.owl.to(e, i.dotsSpeed),
            t.preventDefault()
        }, this))
    }
    ,
    e.prototype.render = function() {
        ...
        if (e.thumbsPrerendered ? (this._thumbcontent._thumbcontainer = s("." + e.thumbContainerClass),
        e.moveThumbsInside && this._thumbcontent._thumbcontainer.appendTo(this.$element)) : this._thumbcontent._thumbcontainer = s("<div>").addClass(e.thumbContainerClass).appendTo(this.$element),
        e.thumbImage)
    ...
    i.fn.counterUp = function(t) {
        ...
        return this.each(function() {
            ...
            l.waypoint(function() {
                ...
                /^[0-9]+\.[0-9]+$/.test(i)), n = o ? (i.split(".")[1] || []).length : 0, a = e; 1 <= a; a--) {
                    var r = parseInt(i / e * a);
                    if (o && (r = parseFloat(i / e * a).toFixed(n)),
                    s)
...
function(f, o, t, g) {
    ...
    h.prototype = {
        ...
        _defineSetters: function() {
            ...
            : f.noop,
            this._setPosition = a.setPosition || function(t, e, i, s, o) {
                n.options.horizontalScrolling && a.setLeft(t, e, i),
                n.options.verticalScrolling && a.setTop(t, s, o)
            }
        },
        ...
        _findParticles: function() {
            ...
            this.options.parallaxElements && this.$element.find("[data-stellar-ratio]").each(function(t) {
                var e, i, s, o, n, a, r, l = f(this), h = 0, c = 0, d = 0, u = 0;
        ...
        _findBackgrounds: function() {
            ...
            t.each(function() {
                var t, e, i, s, o, n = f(this), a = v(n), r = 0, l = 0, h = 0, c = 0;
                if (n.data("stellar-backgroundIsActive")) {
                    if (n.data("stellar-backgroundIsActive") !== this)
                        return
                } else
                    n.data("stellar-backgroundIsActive", this);
                n.data("stellar-backgroundStartingLeft") ? m(n, n.data("stellar-backgroundStartingLeft"), n.data("stellar-backgroundStartingTop")) : (n.data("stellar-backgroundStartingLeft", a[0]),
                n.data("stellar-backgroundStartingTop", a[1])),
                ...
                t = n.data("stellar-horizontal-offset") !== g ? n.data("stellar-horizontal-offset") : o !== g && o.data("stellar-horizontal-offset") !== g ? o.data("stellar-horizontal-offset") : d.horizontalOffset,
                e = n.data("stellar-vertical-offset") !== g ? n.data("stellar-vertical-offset") : o !== g && o.data("stellar-vertical-offset") !== g ? o.data("stellar-vertical-offset") : d.verticalOffset,
                d.backgrounds.push({
                    $element: n,
                    $offsetParent: o,
        ...
        _repositionElements: function() {
            var t, e, i, s, o, n, a, r, l, h, c = this._getScrollLeft(), d = this._getScrollTop(), u = !0, p = !0;
            if (this.currentScrollLeft !== c || this.currentScrollTop !== d || this.currentWidth !== this.viewportWidth || this.currentHeight !== this.viewportHeight) {
                ...
                h = this.particles.length - 1; 0 <= h; h--)
                    ...
                    r = this.options.horizontalScrolling ? (n = (c + t.horizontalOffset + this.viewportOffsetLeft + t.startingPositionLeft - t.startingOffsetLeft + t.parentOffsetLeft) * -(t.stellarRatio + e - 1) + t.startingPositionLeft) - t.startingPositionLeft + t.startingOffsetLeft : (n = t.startingPositionLeft,
                    t.startingOffsetLeft),
                    l = this.options.verticalScrolling ? (a = (d + t.verticalOffset + this.viewportOffsetTop + t.startingPositionTop - t.startingOffsetTop + t.parentOffsetTop) * -(t.stellarRatio + e - 1) + t.startingPositionTop) - t.startingPositionTop + t.startingOffsetTop : (a = t.startingPositionTop,
                    t.startingOffsetTop),
                    this.options.hideDistantElements && (p = !this.options.horizontalScrolling || r + t.width > (t.isFixed ? 0 : c) && r < (t.isFixed ? 0 : c) + this.viewportWidth + this.viewportOffsetLeft,
                    ...
                    t.isHidden = !1),
                    this._setPosition(t.$element, n, t.startingPositionLeft, a, t.startingPositionTop)) : t.isHidden || (this.options.hideElement(t.$element),
                    t.isHidden = !0);
...
function() {
    ...
    i.prototype.handleScroll = function() {
        ...
        for (t in s) {
            var o, n = s[t], a = n.newScroll > n.oldScroll ? n.forward : n.backward;
            for (o in this.waypoints[t]) {
                var r, l, h = this.waypoints[t][o];
                null !== h.triggerPoint && (r = n.oldScroll < h.triggerPoint,
                l = n.newScroll >= h.triggerPoint,
                (r && l || !r && !l) && (h.queueTrigger(a),
    ...
    i.prototype.refresh = function() {
        ...
        t = {
            ...
            for (n in this.waypoints[e]) {
                var r, l = this.waypoints[e][n], h = l.options.offset, c = l.triggerPoint, d = 0, u = null == c;
                l.element !== l.element.window && (d = l.adapter.offset()[a.offsetProp]),
                "function" == typeof h ? h = h.apply(l) : "string" == typeof h && (h = parseFloat(h),
                -1 < l.options.offset.indexOf("%") && (h = Math.ceil(a.contextDimension * h / 100))),
                r = a.contextScroll - a.contextOffset,
                l.triggerPoint = Math.floor(d + r - h),
                r = c < a.oldScroll,
                h = l.triggerPoint >= a.oldScroll,
                c = !r && !h,
                !u && (r && h) ? (l.queueTrigger(a.backward),
                o[l.group.id] = l.group) : (!u && c || u && a.oldScroll >= l.triggerPoint) && (l.queueTrigger(a.forward),
...
function(h) {
    ...
    h.fn.countdown = function(t, n) {
        ...
        function e() {
            ...
            e = Math.floor(i / 60);
            i -= 60 * e,
            1 == s ? a.find(".timeRefDays").text("day") : a.find(".timeRefDays").text("days"),
            1 == o ? a.find(".timeRefHours").text("hour") : a.find(".timeRefHours").text("hours"),
            1 == e ? a.find(".timeRefMinutes").text("minute") : a.find(".timeRefMinutes").text("minutes"),
            1 == i ? a.find(".timeRefSeconds").text("second") : a.find(".timeRefSeconds").text("seconds"),
            "on" == r.format && (s = 2 <= String(s).length ? s : "0" + s,
            ...
            clearInterval(l)) : (a.find(".days").text(s),
            a.find(".hours").text(o),
...
function() {
    ...
    ,
    h),
    s = this.MutationObserver || this.WebkitMutationObserver || this.MozMutationObserver || (r.notSupported = !0,
        ...
        for (n in t)
            ...
            e.push(function() {
                for (var t, e = [], i = 0, s = (t = this.vendors).length; i < s; i++)
                    r = t[i],
                    e.push(o["" + r + n.charAt(0).toUpperCase() + n.substr(1)] = a);
                return e
            }
            .call(this));
        return e
    ...
    n.prototype.vendorCSS = function(t, e) {
        for (var i, s, o, n = (s = l(t)).getPropertyCSSValue(e), a = 0, r = (i = this.vendors).length; a < r; a++)
            o = i[a],
...
function(t) {
    ...
    var f, s, g, o, m, e, l = "Close", v = "BeforeClose", y = "MarkupParse", w = "Open", b = ".mfp", x = "mfp-ready", i = "mfp-removing", a = "mfp-prevent-close", r = !!window.jQuery, C = h(window);
    t.prototype = {
        constructor: t,
        init: function() {
        ...
        open: function(t) {
            ...
            if (!f.isOpen) {
                ...
                f.bgOverlay || (f.bgOverlay = d("bg").on("click" + b, function() {
                    f.close()
                }),
                ...
                u("BeforeOpen"),
                f.st.showCloseBtn && (f.st.closeBtnInside ? (c(y, function(t, e, i, s) {
                ...
                var a = f.wH = C.height()
                  , r = {};
                f.fixedContentPos && f._hasScrollBar(a) && ((l = f._getScrollbarSize()) && (r.marginRight = l)),
                f.fixedContentPos && (f.isIE7 ? h("body, html").css("overflow", "hidden") : r.overflow = "hidden");
                ...
                setTimeout(function() {
                    f.content ? (f._addClassToMFP(x),
                    f._setFocus()) : f.bgOverlay.addClass(x),
        ...
        _hasScrollBar: function(t) {
            return (f.isIE7 ? g.height() : document.body.scrollHeight) > (t || C.height())
        },
        _setFocus: function() {
    ...
    h.fn.magnificPopup = function(t) {
        n();
        var e, i, s, o = h(this);
        return "string" == typeof t ? "open" === t ? (e = r ? o.data("magnificPopup") : o[0].magnificPopup,
        ...
        r ? o.data("magnificPopup", t) : o[0].magnificPopup = t,
        f.addGroup(o, t)),
        o
    }
    ;
    function _() {
        $ && (k.after($.addClass(T)).detach(),
        $ = null)
    }
    var T, k, $, D = "inline";
        ...
        proto: {
            ...
            getInline: function(t, e) {
                ...
                t.src) {
                    ...
                    k = d(T),
                    T = "mfp-" + T),
                    $ = o.after(k).detach().removeClass(T)),
        ...
        proto: {
                ...
                var i = 0
                  ...
                  , o = function(t) {
                    ...
                    A = setInterval(function() {
                        return 0 < s.naturalWidth ? void f._onImageHasSize(e) : (200 < i && clearInterval(A),
            ...
            getImage: function(t, e) {
                var i, s = 0, o = function() {
                    ...
                    t === f.currItem && (f._onImageHasSize(t),
                    f.updateStatus("error", a.tError.replace("%url%", t.src))),
                    t.hasSize = !0,
                    t.loaded = !0,
                    t.loadError = !0)
                }, a = f.st.image, r = e.find(".mfp-img");
                return r.length && ((i = document.createElement("img")).className = "mfp-img",
                ...
                f.updateStatus("error", a.tError.replace("%url%", t.src))) : (e.removeClass("mfp-loading"),
    ...
    h.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            initZoom: function() {
                var t, e, i, s, o, n, a = f.st.zoom, r = ".zoom";
                a.enabled && f.supportsTransition && (s = a.duration,
                o = function(t) {
    ...
    function O(t) {
        var e;
        !f.currTemplate[F] || (e = f.currTemplate[F].find("iframe")).length && (t || (e[0].src = "//about:blank"),
        ...
        proto: {
            initGallery: function() {
                ...
                c("BuildControls" + t, function() {
                    ...
                    t = f.arrowLeft = h(e.replace(/%title%/gi, n.tPrev).replace(/%dir%/gi, "left")).addClass(a),
                    e = f.arrowRight = h(e.replace(/%title%/gi, n.tNext).replace(/%dir%/gi, "right")).addClass(a),
                    t.click(function() {
                        f.prev()
                    }),
                    e.click(function() {
    ...
    h.magnificPopup.registerModule(H, {
        ...
        proto: {
            initRetina: function() {
                ...
                s = i.ratio,
                1 < (s = isNaN(s) ? s() : s) && (c("ImageHasSize." + H, function(t, e) {
                    e.img.css({
...
function(t) {
    ...
    function y(t, n) {
        ...
        this.format = S.parseFormat(n.format || this.element.data("date-format") || D[this.language].format || S.getDefaultFormat(this.formatType, "input"), this.formatType),
        this.isInline = !1,
        this.isVisible = !1,
        ...
        for (var i = 3 === this.bootcssVer ? S.templateV3 : S.template; -1 !== i.indexOf("{iconType}"); )
    ...
    y.prototype = {
        ...
        getFormattedDate: function(t) {
            ...
            S.formatDate(this.date, t, this.language, this.formatType, this.timezone)
        },
        setStartDate: function(t) {
            this.startDate = t || this.startDate,
            8639968443048e3 !== this.startDate.valueOf() && (this.startDate = S.parseDate(this.startDate, this.format, this.language, this.formatType, this.timezone)),
            this.update(),
            this.updateNavArrows()
        },
        setEndDate: function(t) {
            this.endDate = t || this.endDate,
            8639968443048e3 !== this.endDate.valueOf() && (this.endDate = S.parseDate(this.endDate, this.format, this.language, this.formatType, this.timezone)),
            this.update(),
            this.updateNavArrows()
        },
        setDatesDisabled: function(t) {
            ...
            this.datesDisabled = T.map(this.datesDisabled, function(t) {
                return S.parseDate(t, e.format, e.language, e.formatType, e.timezone).toDateString()
            }),
            this.update(),
            this.updateNavArrows()
        },
        ...
        update: function() {
            ...
            this.date = S.parseDate(t, this.format, this.language, this.formatType, this.timezone),
            e && this.setValue(),
        ...
        fill: function() {
            if (this.date && this.viewDate) {
                ...
                "time" === this.formatViewType ? (_ = this.getFormattedDate(),
                this.setTitle(".datetimepicker-hours", _),
                this.setTitle(".datetimepicker-minutes", _)) : (this.setTitle(".datetimepicker-hours", i + " " + D[this.language].months[e] + " " + t),
                ...
                this.updateNavArrows(),
                this.fillMonths();
                var c = k(t, e - 1, 28, 0, 0, 0, 0)
                  , d = S.getDaysInMonth(c.getUTCFullYear(), c.getUTCMonth());
                c.setUTCDate(d),
                c.setUTCDate(d - (c.getUTCDay() - this.weekStart + 7) % 7);
                var u = new Date(c);
                u.setUTCDate(u.getUTCDate() + 42),
                u = u.valueOf();
                for (var p, f = []; c.valueOf() < u; )
                    c.getUTCDay() === this.weekStart && f.push("<tr>"),
                    p = this.onRenderDay(c),
                    c.getUTCFullYear() < t || c.getUTCFullYear() === t && c.getUTCMonth() < e ? p.push("old") : (c.getUTCFullYear() > t || c.getUTCFullYear() === t && c.getUTCMonth() > e) && p.push("new"),
                    this.todayHighlight && c.getUTCFullYear() === h.getFullYear() && c.getUTCMonth() === h.getMonth() && c.getUTCDate() === h.getDate() && p.push("today"),
                    c.valueOf() === l && p.push("active"),
                    (c.valueOf() + 864e5 <= this.startDate || c.valueOf() > this.endDate || -1 !== T.inArray(c.getUTCDay(), this.daysOfWeekDisabled) || -1 !== T.inArray(c.toDateString(), this.datesDisabled)) && p.push("disabled"),
                    f.push('<td class="' + p.join(" ") + '">' + c.getUTCDate() + "</td>"),
                    c.getUTCDay() === this.weekEnd && f.push("</tr>"),
                    c.setUTCDate(c.getUTCDate() + 1);
                this.picker.find(".datetimepicker-days tbody").empty().append(f.join("")),
                f = [];
                for (var g = "", m = "", v = "", y = this.hoursDisabled || [], w = new Date(this.viewDate), b = 0; b < 24; b++) {
                    w.setUTCHours(b),
                    p = this.onRenderHour(w),
                    -1 !== y.indexOf(b) && p.push("disabled");
                    var x = k(t, e, i, b);
                    x.valueOf() + 36e5 <= this.startDate || x.valueOf() > this.endDate ? p.push("disabled") : s === b && p.push("active"),
                    this.showMeridian && 2 === D[this.language].meridiem.length ? ((m = b < 12 ? D[this.language].meridiem[0] : D[this.language].meridiem[1]) !== v && ("" !== v && f.push("</fieldset>"),
                ...
                for (b = 0; b < 60; b += this.minuteStep)
                    -1 === C.indexOf(b) && (w.setUTCMinutes(b),
                    w.setUTCSeconds(0),
                    p = this.onRenderMinute(w),
                    this.showMeridian && 2 === D[this.language].meridiem.length ? ((m = s < 12 ? D[this.language].meridiem[0] : D[this.language].meridiem[1]) !== v && ("" !== v && f.push("</fieldset>"),
                ...
                _ === t && d.eq(this.date.getUTCMonth()).addClass("active"),
                (t < o || a < t) && d.addClass("disabled"),
                t === o && d.slice(0, n).addClass("disabled"),
                t === a && d.slice(r).addClass("disabled"),
                f = "",
                t = 10 * parseInt(t / 10, 10);
                r = this.setTitle(".datetimepicker-years", t + "-" + (t + 9)).end().find("td");
                --t,
                w = new Date(this.viewDate);
                for (b = -1; b < 11; b++)
                    w.setUTCFullYear(t),
        ...
        click: function(t) {
            t.stopPropagation(),
            t.preventDefault();
            var e, i, s, o, n, a, r = T(t.target).closest("span, td, th, legend");
            if (r.is("." + this.icontype) && (r = T(r).parent().closest("span, td, th, legend")),
            1 === r.length)
                if (r.is(".disabled"))
                    this.element.trigger({
                        type: "outOfRange",
                    ...
                    case "th":
                        ...
                        case "prev":
                        case "next":
                            var l = S.modes[this.viewMode].navStep * ("prev" === r[0].className ? -1 : 1);
                            switch (this.viewMode) {
                            case 0:
                    ...
                    case "span":
                        ...
                        3 <= this.viewSelect && this._setDate(k(i, s, e, o, n, a, 0))) : r.is(".year") ? (this.viewDate.setUTCDate(1),
                        ...
                        4 <= this.viewSelect && this._setDate(k(i, s, e, o, n, a, 0))) : r.is(".hour") ? (o = parseInt(r.text(), 10) || 0,
                        (r.hasClass("hour_am") || r.hasClass("hour_pm")) && (12 === o && r.hasClass("hour_am") ? o = 0 : 12 !== o && r.hasClass("hour_pm") && (o += 12)),
                        this.viewDate.setUTCHours(o),
                        this.element.trigger({
                            type: "changeHour",
                            date: this.viewDate
                        }),
                        1 <= this.viewSelect && this._setDate(k(i, s, e, o, n, a, 0))) : r.is(".minute") && (n = parseInt(r.text().substr(r.text().indexOf(":") + 1), 10) || 0,
                        this.viewDate.setUTCMinutes(n),
                        this.element.trigger({
                            type: "changeMinute",
                            date: this.viewDate
                        }),
                        0 <= this.viewSelect && this._setDate(k(i, s, e, o, n, a, 0))),
                        ...
                        break;
                    case "td":
                        r.is(".day") && !r.is(".disabled") && (e = parseInt(r.text(), 10) || 1,
                        ...
                        2 <= this.viewSelect && this._setDate(k(i, s, e, o, n, a, 0)));
                        var c = this.viewMode;
                        this.showMode(-1),
                        this.fill(),
                        c === this.viewMode && this.autoclose && this.hide()
                    }
        },
        ...
        moveMonth: function(t, e) {
            if (!e)
                return t;
            var i, s, o = new Date(t.valueOf()), n = o.getUTCDate(), a = o.getUTCMonth(), r = Math.abs(e);
            if (e = 0 < e ? 1 : -1,
            1 === r)
                s = -1 === e ? function() {
        ...
        keydown: function(t) {
            if (this.picker.is(":not(:visible)"))
                ...
                case 39:
                    ...
                    4 === a ? (i = this.moveYear(this.date, e),
                    s = this.moveYear(this.viewDate, e)) : 3 === a ? (i = this.moveMonth(this.date, e),
                    s = this.moveMonth(this.viewDate, e)) : 2 === a ? (i = this.moveDate(this.date, e),
                    s = this.moveDate(this.viewDate, e)) : 1 === a ? (i = this.moveHour(this.date, e),
                    s = this.moveHour(this.viewDate, e)) : 0 === a && (i = this.moveMinute(this.date, e),
                ...
                case 40:
                    ...
                    4 === a ? (i = this.moveYear(this.date, e),
                    s = this.moveYear(this.viewDate, e)) : 3 === a ? (i = this.moveMonth(this.date, e),
                    s = this.moveMonth(this.viewDate, e)) : 2 === a ? (i = this.moveDate(this.date, 7 * e),
                    s = this.moveDate(this.viewDate, 7 * e)) : 1 === a ? s = this.showMeridian ? (i = this.moveHour(this.date, 6 * e),
                    this.moveHour(this.viewDate, 6 * e)) : (i = this.moveHour(this.date, 4 * e),
                    this.moveHour(this.viewDate, 4 * e)) : 0 === a && (i = this.moveMinute(this.date, 4 * e),
        ...
        showMode: function(t) {
            !t || (t = Math.max(0, Math.min(S.modes.length - 1, this.viewMode + t))) >= this.minView && t <= this.maxView && (this.element.trigger({
                type: "changeMode",
                date: this.viewDate,
    ...
    T.fn.datetimepicker = function(s) {
        ...
        this.each(function() {
            var t = T(this)
              ...
              , i = "object" == typeof s && s;
            if (e || t.data("datetimepicker", e = new y(this,T.extend({}, T.fn.datetimepicker.defaults, i))),
            "string" == typeof s && "function" == typeof e[s] && (o = e[s].apply(e, n)) !== a)
                return !1
        }),
        o !== a ? o : this
    }
    ...
    var D = T.fn.datetimepicker.dates = {
      ...
      , S = {
        ...
        parseDate: function(t, e, i, s, o) {
            ...
            var c, d, u, l = t && t.toString().match(this.nonpunctuation) || [], t = new Date(0,0,0,0,0,0,0), p = {}, f = ["hh", "h", "ii", "i", "ss", "s", "yyyy", "yy", "M", "MM", "m", "mm", "D", "DD", "d", "dd", "H", "HH", "p", "P", "z", "Z"], g = {
                hh: function(t, e) {
            ...
            l.length === e.parts.length) {
                for (var h = 0, m = e.parts.length; h < m; h++) {
                    if (c = parseInt(l[h], 10),
                    u = e.parts[h],
                    isNaN(c))
                        switch (u) {
                        case "MM":
                            d = T(D[i].months).filter(function() {
                                var t = this.slice(0, l[h].length);
                                return t === l[h].slice(0, t.length)
                            }),
                            c = T.inArray(d[0], D[i].months) + 1;
                            break;
                        case "M":
                            d = T(D[i].monthsShort).filter(function() {
                                var t = this.slice(0, l[h].length)
                                  , e = l[h].slice(0, t.length);
                                return t.toLowerCase() === e.toLowerCase()
                            }),
                            c = T.inArray(d[0], D[i].monthsShort) + 1;
                            break;
                        case "p":
                        case "P":
                            c = T.inArray(l[h].toLowerCase(), D[i].meridiem)
                        }
                    p[u] = c
                }
                for (var v, h = 0; h < f.length; h++)
                    (v = f[h])in p && !isNaN(p[v]) && g[v](t, p[v])
            }
            return t
        },
        formatDate: function(t, e, i, s, o) {
            ...
            for (var t = [], a = T.extend([], e.separators), r = 0, l = e.parts.length; r < l; r++)
...
function(t, e) {
    ...
    !function() {
        ...
        e.prototype.loadContent = function(e, t, i) {
            var s, r, o, n, a, l, h = this, c = !1, d = function(t) {
                ...
                for (var n = f(window).width(), a = 0; a < e.length; a++)
                    if (parseInt(e[a], 10) > n) {
                        r = i[a];
                        break
                    }
            }, u = h.s.dynamic ? (h.s.dynamicEl[e].poster && (c = !0,
            o = h.s.dynamicEl[e].poster),
            a = h.s.dynamicEl[e].html,
            r = h.s.dynamicEl[e].src,
            l = h.s.dynamicEl[e].alt,
            h.s.dynamicEl[e].responsive && d(h.s.dynamicEl[e].responsive.split(",")),
            n = h.s.dynamicEl[e].srcset,
            h.s.dynamicEl[e].sizes) : ((p = h.$items.eq(e)).attr("data-poster") && (c = !0,
            ...
            h.s.dynamic ? h.s.dynamicEl[e].iframe && (d = !0) : "true" === h.$items.eq(e).attr("data-iframe") && (d = !0);
            var p = h.isVideo(r, e);
            if (!h.$slide.eq(e).hasClass("lg-loaded")) {
                if (d ? h.$slide.eq(e).prepend('<div class="lg-video-cont lg-has-iframe" style="max-width:' + h.s.iframeMaxWidth + '"><div class="lg-video"><iframe class="lg-object" frameborder="0" src="' + r + '"  allowfullscreen="true"></iframe></div></div>') : c ? (d = "",
                d = p && p.youtube ? "lg-has-youtube" : p && p.vimeo ? "lg-has-vimeo" : "lg-has-html5",
                h.$slide.eq(e).prepend('<div class="lg-video-cont ' + d + ' "><div class="lg-video"><span class="lg-video-play"></span><img class="lg-object lg-has-poster" src="' + o + '" /></div></div>')) : p ? (h.$slide.eq(e).prepend('<div class="lg-video-cont "><div class="lg-video"></div></div>'),
                h.$el.trigger("hasVideo.lg", [e, r, a])) : (l = l ? 'alt="' + l + '"' : "",
                h.$slide.eq(e).prepend('<div class="lg-img-wrap"><img class="lg-object lg-image" ' + l + ' src="' + r + '" /></div>')),
            ...
            p && p.html5 && !c && h.$slide.eq(e).addClass("lg-complete"),
        ...
        e.prototype.slide = function(t, e, i, s) {
            var o, n, a, r, l, h = this.$outer.find(".lg-current").index(), c = this;
            c.lGalleryOn && h === t || (o = this.$slide.length,
            n = c.lGalleryOn ? this.s.speed : 0,
            c.lgBusy || (this.s.download && ((a = c.s.dynamic ? !1 !== c.s.dynamicEl[t].downloadUrl && (c.s.dynamicEl[t].downloadUrl || c.s.dynamicEl[t].src) : "false" !== c.$items.eq(t).attr("data-download-url") && (c.$items.eq(t).attr("data-download-url") || c.$items.eq(t).attr("href") || c.$items.eq(t).attr("data-src"))) ? (f("#lg-download").attr("href", a),
            ...
            r = o - 1)) : (r = 0,
            l = 1),
            "prev" === s ? c.$slide.eq(l).addClass("lg-next-slide") : c.$slide.eq(r).addClass("lg-prev-slide"),
        ...
        t.prototype.init = function() {
            ...
            i.core.s.dynamic)
                ...
                i.core.$items.each(function() {
                    i.core.s.exThumbImage ? o += '<span class="lg-pager-cont"> <span class="lg-pager"></span><div class="lg-pager-thumb-cont"><span class="lg-caret"></span> <img src="' + a(this).attr(i.core.s.exThumbImage) + '" /></div></span>' : o += '<span class="lg-pager-cont"> <span class="lg-pager"></span><div class="lg-pager-thumb-cont"><span class="lg-caret"></span> <img src="' + a(this).find("img").attr("src") + '" /></div></span>'
                });
    ...
    !function() {
        ...
        t.prototype.build = function() {
            ...
            function e(t, e, i) {
                ...
                t.youtube || t.vimeo || t.dailymotion ? t.youtube ? s = o.core.s.loadYoutubeThumbnail ? "//img.youtube.com/vi/" + t.youtube[1] + "/" + o.core.s.youtubeThumbSize + ".jpg" : e : t.vimeo ? o.core.s.loadVimeoThumbnail ? (s = "//i.vimeocdn.com/video/error_" + a + ".jpg",
            ...
            o.core.s.dynamic)
                ...
                o.core.$items.each(function(t) {
                    o.core.s.exThumbImage ? e(r(this).attr("href") || r(this).attr("data-src"), r(this).attr(o.core.s.exThumbImage), t) : e(r(this).attr("href") || r(this).attr("data-src"), r(this).find("img").attr("src"), t)
                });
            o.core.$outer.find(".lg-thumb").html(n),
            (t = o.core.$outer.find(".lg-thumb-item")).each(function() {
                var e = r(this)
                  , t = e.attr("data-vimeo-id");
                t && r.getJSON("//www.vimeo.com/api/v2/video/" + t + ".json?callback=?", {
                    format: "json"
                }, function(t) {
            ...
            r(window).on("resize.lg.thumb orientationchange.lg.thumb", function() {
                setTimeout(function() {
                    o.animateThumb(o.core.index),
                    o.thumbOuterWidth = o.$thumbOuter.width()
                }, 200)
        ...
        t.prototype.enableThumbDrag = function() {
            ...
            r(window).on("mousemove.lg.thumb", function(t) {
                ...
                (a -= s - i) > e.thumbTotalWidth - e.thumbOuterWidth && (a = e.thumbTotalWidth - e.thumbOuterWidth),
                a < 0 && (a = 0),
                e.setTranslate(a))
            }),
        ...
        ,
        t.prototype.destroy = function() {
            this.core.s.thumbnail && 1 < this.core.$items.length && (r(window).off("resize.lg.thumb orientationchange.lg.thumb keydown.lg.thumb"),
...
function(t, e) {
    ...
    !function() {
        ...
        t.prototype.loadVideo = function(t, e, i, s, o) {
            ...
            return n = n ? 'title="' + n + '"' : "",
            i && (r = !this.videoLoaded && this.core.s.autoplayFirstVideo ? 1 : 0),
            s.youtube ? (l = "?wmode=opaque&autoplay=" + r + "&enablejsapi=1",
            this.core.s.youtubePlayerParams && (l = l + "&" + h.param(this.core.s.youtubePlayerParams)),
            a = '<iframe class="lg-video-object lg-youtube ' + e + '" ' + n + ' width="560" height="315" src="//www.youtube.com/embed/' + s.youtube[1] + l + '" frameborder="0" allowfullscreen></iframe>') : s.vimeo ? (l = "?autoplay=" + r + "&api=1",
            this.core.s.vimeoPlayerParams && (l = l + "&" + h.param(this.core.s.vimeoPlayerParams)),
            a = '<iframe class="lg-video-object lg-vimeo ' + e + '" ' + n + ' width="560" height="315"  src="//player.vimeo.com/video/' + s.vimeo[1] + l + '" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>') : s.dailymotion ? (l = "?wmode=opaque&autoplay=" + r + "&api=postMessage",
            this.core.s.dailymotionPlayerParams && (l = l + "&" + h.param(this.core.s.dailymotionPlayerParams)),
            a = '<iframe class="lg-video-object lg-dailymotion ' + e + '" ' + n + ' width="560" height="315" src="//www.dailymotion.com/embed/video/' + s.dailymotion[1] + l + '" frameborder="0" allowfullscreen></iframe>') : s.html5 ? ("." !== (i = o.substring(0, 1)) && "#" !== i || (o = h(o).html()),
            a = o) : s.vk && (l = "&autoplay=" + r,
            this.core.s.vkPlayerParams && (l = l + "&" + h.param(this.core.s.vkPlayerParams)),
            a = '<iframe class="lg-video-object lg-vk ' + e + '" ' + n + ' width="560" height="315" src="//vk.com/video_ext.php?' + s.vk[1] + l + '" frameborder="0" allowfullscreen></iframe>'),
            a
        }
        ,
    ...
    !function() {
        ...
        t.prototype.init = function() {
            ...
            function s(t, e, i, s) {
                ...
                n.core.$outer.hasClass("lg-zoomed") ? r = 1 : o < e && (r = e / o || 2),
            ...
            u("#lg-zoom-out").on("click.lg", function() {
                n.core.$outer.find(".lg-current .lg-image").length && (r -= n.core.s.scale,
                a())
            }),
        ...
        t.prototype.zoomSwipe = function() {
            var s, o = this, n = {}, a = {}, r = !1, l = !1, h = !1, c = 0;
            o.core.$slide.on("touchstart.lg", function(t) {
                ...
                n = o.getSwipeCords(t, Math.abs(c))))
            }),
            o.core.$slide.on("touchmove.lg", function(t) {
                ...
                t.preventDefault(),
                r = !0,
                a = o.getSwipeCords(t, Math.abs(c)),
                o.core.$outer.addClass("lg-zoom-dragging"),
                i = h ? -Math.abs(e.attr("data-y")) + (a.y - n.y) * o.getModifier(c, "Y", s) : -Math.abs(e.attr("data-y")),
                t = l ? -Math.abs(e.attr("data-x")) + (a.x - n.x) * o.getModifier(c, "X", s) : -Math.abs(e.attr("data-x")),
                (15 < Math.abs(a.x - n.x) || 15 < Math.abs(a.y - n.y)) && (o.core.s.useLeftForZoom ? e.css({
                    left: t + "px",
                    top: i + "px"
                }) : e.css("transform", "translate3d(" + t + "px, " + i + "px, 0)")))
            }),
            o.core.$slide.on("touchend.lg", function() {
                o.core.$outer.hasClass("lg-zoomed") && r && (r = !1,
                o.core.$outer.removeClass("lg-zoom-dragging"),
                o.touchendZoom(n, a, l, h, c))
            })
        }
        ,
        t.prototype.zoomDrag = function() {
            var s, o = this, n = {}, a = {}, r = !1, l = !1, h = !1, c = !1, d = 0;
            o.core.$slide.on("mousedown.lg.zoom", function(t) {
                ...
                c = e.allowY,
                h = e.allowX,
                o.core.$outer.hasClass("lg-zoomed") && u(t.target).hasClass("lg-object") && (h || c) && (t.preventDefault(),
            ...
            u(window).on("mousemove.lg.zoom", function(t) {
                var e, i;
                r && (e = o.core.$slide.eq(o.core.index).find(".lg-img-wrap"),
                l = !0,
                a = o.getDragCords(t, Math.abs(d)),
                o.core.$outer.addClass("lg-zoom-dragging"),
                i = c ? -Math.abs(e.attr("data-y")) + (a.y - n.y) * o.getModifier(d, "Y", s) : -Math.abs(e.attr("data-y")),
                t = h ? -Math.abs(e.attr("data-x")) + (a.x - n.x) * o.getModifier(d, "X", s) : -Math.abs(e.attr("data-x")),
            ...
            u(window).on("mouseup.lg.zoom", function(t) {
                r && (r = !1,
                o.core.$outer.removeClass("lg-zoom-dragging"),
                !l || n.x === a.x && n.y === a.y || (a = o.getDragCords(t, Math.abs(d)),
                o.touchendZoom(n, a, h, c, d)),
                l = !1),
        ...
        t.prototype.touchendZoom = function(t, e, i, s, o) {
            var n = this
              ...
              , h = -Math.abs(a.attr("data-x")) + (e.x - t.x) * n.getModifier(o, "X", l)
              , l = -Math.abs(a.attr("data-y")) + (e.y - t.y) * n.getModifier(o, "Y", l)
            ...
            s ? a.attr("data-y", Math.abs(l)) : l = -Math.abs(a.attr("data-y")),
            i ? a.attr("data-x", Math.abs(h)) : h = -Math.abs(a.attr("data-x")),
            n.core.s.useLeftForZoom ? a.css({
                left: h + "px",
                top: l + "px"
            }) : a.css("transform", "translate3d(" + h + "px, " + l + "px, 0)"))
        }
        ,
        t.prototype.destroy = function() {
            var t = this;
...
function(t) {
    ...
    function e(t) {
        var e, i = t || window.event, s = g.call(arguments, 1), o = 0, n = 0, a = 0, r = 0, l = 0, h = 0;
        ...
        "axis"in i && i.axis === i.HORIZONTAL_AXIS && (n = -1 * a,
        a = 0),
        o = 0 === a ? n : a,
        ...
        0 !== a || 0 !== n) {
            ...
            a *= e,
            n *= e) : 2 === i.deltaMode && (o *= e = c.data(this, "mousewheel-page-height"),
            a *= e,
            n *= e);
            var r = Math.max(Math.abs(a), Math.abs(n));
            return f && !(r < f) || u(i, f = r) && (f /= 40),
            u(i, r) && (o /= 40,
            n /= 40,
            a /= 40),
            ...
            m.settings.normalizeOffset && this.getBoundingClientRect && (r = this.getBoundingClientRect(),
            l = t.clientX - r.left,
            h = t.clientY - r.top),
            t.deltaX = n,
            t.deltaY = a,
    ...
    if (c.event.fixHooks)
        for (var s = t.length; s; )
            c.event.fixHooks[t[--s]] = c.event.mouseHooks;
  ...
  , Prism = function(l) {
    var h = /\blang(?:uage)?-([\w-]+)\b/i
      ...
      , M = {
        ...
        util: {
            encode: function(t) {
                return t instanceof z ? new z(t.type,M.util.encode(t.content),t.alias) : Array.isArray(t) ? t.map(M.util.encode) : t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/\u00a0/g, " ")
            },
            type: function(t) {
            ...
            clone: function i(t, s) {
                ...
                case "Object":
                    ...
                    s[e] = o,
                    t)
                        t.hasOwnProperty(a) && (o[a] = i(t[a], s));
                    return o;
                case "Array":
        ...
        languages: {
            ...
            DFS: function t(e, i, s, o) {
                o = o || {};
                var n, a, r, l = M.util.objId;
                for (n in e)
                    e.hasOwnProperty(n) && (i.call(e, n, e[n], s || n),
                    a = e[n],
                    "Object" !== (r = M.util.type(a)) || o[l(a)] ? "Array" !== r || o[l(a)] || (o[l(a)] = !0,
                    t(a, i, n, o)) : (o[l(a)] = !0,
                    t(a, i, null, o)))
            }
        },
        ...
        highlightAllUnder: function(t, e, i) {
            ...
            for (var o, n = s.elements || t.querySelectorAll(s.selector), a = 0; o = n[a++]; )
                M.highlightElement(o, !0 === e, s.callback)
        },
        highlightElement: function(t, e, i) {
            ...
            r.code ? (M.hooks.run("before-highlight", r),
            r.grammar ? e && l.Worker ? ((e = new Worker(M.filename)).onmessage = function(t) {
                a(t.data)
            }
            ,
            e.postMessage(JSON.stringify({
                ...
                code: r.code,
                immediateClose: !0
            }))) : a(M.highlight(r.code, r.grammar, r.language)) : a(M.util.encode(r.code))) : M.hooks.run("complete", r)
        },
        highlight: function(t, e, i) {
            ...
            return M.hooks.run("before-tokenize", i),
            i.tokens = M.tokenize(i.code, i.grammar),
            M.hooks.run("after-tokenize", i),
            z.stringify(M.util.encode(i.tokens), i.language)
        },
        matchGrammar: function(t, e, i, s, o, n, a) {
            for (var r in i)
                if (i.hasOwnProperty(r) && i[r]) {
                    if (r == a)
                        return;
                    for (var l = i[r], l = "Array" === M.util.type(l) ? l : [l], h = 0; h < l.length; ++h) {
                        var c, d = l[h], u = d.inside, p = !!d.lookbehind, f = !!d.greedy, g = 0, m = d.alias;
                        f && !d.pattern.global && (c = d.pattern.toString().match(/[imuy]*$/)[0],
                        d.pattern = RegExp(d.pattern.source, c + "g")),
                        d = d.pattern || d;
                        for (var v = s, y = o; v < e.length; y += e[v].length,
                        ++v) {
                            var w = e[v];
                            ...
                            if (!(w instanceof z)) {
                                if (f && v != e.length - 1) {
                                    ...
                                    !(k = d.exec(t)))
                                        break;
                                    for (var b = k.index + (p ? k[1].length : 0), x = k.index + k[0].length, C = v, _ = y, T = e.length; C < T && (_ < x || !e[C].type && !e[C - 1].greedy); ++C)
                                        (_ += e[C].length) <= b && (++v,
                                        y = _);
                                    if (e[v]instanceof z)
                                        continue;
                                ...
                                if (k) {
                                    ...
                                    x = (b = k.index + g) + (k = k[0].slice(g)).length;
                                    var D = w.slice(0, b)
                                      , S = w.slice(x)
                                      , w = [v, $];
                                    D && (++v,
                                    y += D.length,
                                    w.push(D));
                                    D = new z(r,u ? M.tokenize(k, u) : k,m,k,f);
                                    if (w.push(D),
                                    S && w.push(S),
                                    Array.prototype.splice.apply(e, w),
                                    1 != $ && M.matchGrammar(t, e, i, v, y, !0, r),
                                    n)
                                        break
                                } else if (n)
                                    break
    ...
    if (l.Prism = M,
    z.stringify = function(t, e) {
        if ("string" == typeof t)
            return t;
        if (Array.isArray(t))
            return t.map(function(t) {
                return z.stringify(t, e)
            }).join("");
        var i = {
            type: t.type,
            content: z.stringify(t.content, e),
            tag: "span",
    ...
    ,
    !l.document)
        return l.addEventListener && (M.disableWorkerMessageHandler || l.addEventListener("message", function(t) {
