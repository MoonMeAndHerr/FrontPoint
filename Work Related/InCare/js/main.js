...
!function(t) {
    ...
    o.on("scroll", function() {
        ...
        a.attr("src", "img/logos/logo-white.png")) : (t("header").removeClass("fixedHeader").addClass("scrollHeader"),
    ...
    t(".appointment").magnificPopup({
        type: "inline",
        preloader: !1
    }),
    t(".form_date").datetimepicker({
        language: "en",
        weekStart: 1,
        todayBtn: 1,
        autoclose: 1,
    ...
    a(),
    0 !== t(".copy-clipboard").length && (new ClipboardJS(".copy-clipboard"),
    ...
    t(document).ready(function() {
        ...
        t(".portfolio-carousel-03").owlCarousel({
            loop: !0,
            responsiveClass: !0,
            nav: !1,
            navText: ["<i class='ti-arrow-left'></i>", "<i class='ti-arrow-right'></i>"],
        ...
        t(".slider-fade2").on("changed.owl.carousel", function(e) {
            ...
            t("p").removeClass("animated fadeInUp"),
            t("a").removeClass("animated fadeInUp"),
            t(".owl-item").not(".cloned").eq(e).find(".sub-title").addClass("animated fadeInUp"),
            t(".owl-item").not(".cloned").eq(e).find("h1").addClass("animated fadeInUp"),
            t(".owl-item").not(".cloned").eq(e).find("p").addClass("animated fadeInUp"),
            t(".owl-item").not(".cloned").eq(e).find("a").addClass("animated fadeInUp")
        }),
