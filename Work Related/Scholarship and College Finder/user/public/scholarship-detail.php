<?php
    ...
    $pdo = openDB();
    $sql = "SELECT * FROM scholarships INNER JOIN locations 
            ON scholarships.location_id = locations.location_id
            INNER JOIN categories ON scholarships.category_id = categories.category_id
                        ...
                        <div class="breadcrumbs-inner">
                            <div class="container">
                                <div class="breadcrumbs-text">
                                    <a href="#" class="cate">Scholarships</a>
                                    <h1 class="breadcrumbs-title"><?php echo $row['title']; ?></h1>
                                </div>
                            </div>
                        </div>
                    </div>                
                                ...
                                <div class="react-sidebar react-back-course2 ml----30">                                                                        
                                    <div class="widget get-back-course">                                                                             
                                        <ul class="price__course">
                                            ...
                                            <li> <i class="icon_group"></i> Category <b><?php echo $row['name']; ?></b></li>
                                            <li><i class="icon_clock_alt"></i> Created At <b><?php echo $row['created_at']; ?></b></li>
                                        </ul>
                                        <a href="../private/application?scholarship=<?php echo $row['scholarship_id']; ?>" class="start-btn">Apply Now!<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-right"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg></a>
                                        <a href="../private/saved-items?scholarship=<?php echo $row['scholarship_id']; ?>" class="start-btn">Add To Saved Items<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-right"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg></a>
                                    </div>                                
                                </div>
                            </div>
                        </div>
