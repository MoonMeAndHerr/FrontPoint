                        ...
                        <div class="breadcrumbs-inner">
                            <div class="container">
                                <div class="breadcrumbs-text">
                                    <h1 class="breadcrumbs-title">Scholarships</h1>
                                    <div class="back-nav">
                                        <ul>
                                            <li><a href="index">Home</a></li>
                                            <li>List of Scholarships</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="single-studies col-lg-4 grid-item">
                                <div class="inner-course">
                                    ...
                                    <div class="case-content">                                        
                                        <h4 class="case-title"> <a href="scholarship-detail?id=<?php echo $row['scholarship_id']; ?>"><?php echo $row['name']; ?></a></h4> 
                                        <a class="event__card--link" href="scholarship-detail?id=<?php echo $row['scholarship_id']; ?>"> Apply Now <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-right"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg></a>
                                    </div>
                                </div>
                            </div>
